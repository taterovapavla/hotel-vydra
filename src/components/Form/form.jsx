  ...
  return (
    <form>
      <div className='form__fields'>
        ...
        <label className='field__label' htmlFor="">Domácí mazlíček: </label>
        <input className='field__input' type="checkbox" id="mazlicci" />

        <label className='field__label' htmlFor="">Přistýlka pro dítě: </label>
        <input className='field__input' type="checkbox" id="pristylka" />

        <label className='field__label' htmlFor="">Bezbariérový přístup: </label>
        <input className='field__input' type="checkbox" id="bezbarierove" />

        <label className='field__label' htmlFor="">Email: </label>
        <input className='field__input' type="email" id="email" />

        <label className='field__label' htmlFor="">Telefon: </label>
